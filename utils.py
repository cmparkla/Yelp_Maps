...
def key_of_min_value(d):
    ...
    # return min( takes in key function and how you get iterms from dictionary)
...
def enumerate(s, start=0):
    ...
    [[5, 'f'], [6, 'i'], [7, 'v'], [8, 'e']]
    """
    # return [[start + i, s[i]] for i in s]
    return zip([start + i for i in range(len(s))], [i for i in s])
